...
public class ServiceLink_ {
     ...
     * @param serviceId
     */
    public ServiceLink_(String serviceUserId, Long serviceId, String displayName) {
        super();
    ...
    public ServiceLink_ withServiceUserId(String serviceUserId) {
        this.serviceUserId = serviceUserId;
        return this;
    }
    ...
    public ServiceLink_ withServiceId(Long serviceId) {
        this.serviceId = serviceId;
        return this;
    }
    ...
    public ServiceLink_ withDisplayName(String displayName) {
        this.displayName = displayName;
        return this;
    }
    ...
    public ServiceLink_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ServiceLink_) == false) {
            return false;
        }
        ServiceLink_ rhs = ((ServiceLink_) other);
