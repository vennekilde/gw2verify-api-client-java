...
public class Name {
    ...
    /**
     * Get a service user's apikey name they are required to use if apikey name
     * restriction is enforced
     *
     */
    public com.farshiverpeaks.gw2verifyclient.model.APIKeyName get(NameGETHeader headers) throws GuildWars2VerificationAPIException {
