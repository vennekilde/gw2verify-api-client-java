...
public class PropertiesGETResponse {
     ...
     * @param value
     */
    public PropertiesGETResponse(String name, String value) {
        super();
        this.name = name;
        this.value = value;
    }
    ...
    public PropertiesGETResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public PropertiesGETResponse withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public PropertiesGETResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PropertiesGETResponse) == false) {
            return false;
        }
        PropertiesGETResponse rhs = ((PropertiesGETResponse) other);
